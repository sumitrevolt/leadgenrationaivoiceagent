...
- **USER DECISION (2026-06-07): Plivo/Vobiz pilot SKIP — seedha operator-direct SIP (Tata Smartflo / Airtel B2B) jana hai.** User action: dono se quotes (rate/channel-rental/min-commit/FreeSWITCH SIP creds/DLT support), compete karwana. Caveat diya: provisioning 2-4 hafte + rate negotiation volume-commit pe; dev-testing ke liye trunk na hone tak Pipecat web-transport pe ready rakhna (ya ₹500-1K Vobiz test recharge optional). Trunk aate hi FreeSWITCH gateway plug.
