---
name: "source-command-agent-os-shape-spec"
description: "Migrated source command `agent-os-shape-spec`"
---

# source-command-agent-os-shape-spec

Use this skill when the user asks to run the migrated source command `agent-os-shape-spec`.
