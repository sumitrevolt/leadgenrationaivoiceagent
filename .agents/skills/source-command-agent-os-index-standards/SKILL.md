---
name: "source-command-agent-os-index-standards"
description: "Migrated source command `agent-os-index-standards`"
---

# source-command-agent-os-index-standards

Use this skill when the user asks to run the migrated source command `agent-os-index-standards`.
