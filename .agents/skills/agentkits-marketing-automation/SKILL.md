...
Enterprise-grade AI marketing automation for Codex, Cursor, GitHub Copilot, and any AI assistant supporting agents & skills. Production-ready marketing agents, skills, commands, and workflows built for SaaS founders, marketers, and growth teams.
...
```bash
# Codex
npx @aitytech/agentkits-marketing install --platform Codex
...
### Method 2: Codex Plugin Marketplace
...
# Copy agents
cp agentkits-marketing/.Codex/agents/*.md ~/.Codex/agents/

# Copy commands
cp -r agentkits-marketing/.Codex/commands/* ~/.Codex/commands/

# Copy skills
cp -r agentkits-marketing/.Codex/skills/* ~/.Codex/skills/

# Copy workflows
cp -r agentkits-marketing/.Codex/workflows/* ~/.Codex/workflows/
```
...
For Codex plugin users, configuration is in `.Codex-plugin/plugin.json`:
...
~/.Codex/agents/attraction-specialist.md
```
...
# File: .Codex/workflows/primary-workflow.md
