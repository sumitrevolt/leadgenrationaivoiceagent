---
name: "source-command-agent-os-plan-product"
description: "Migrated source command `agent-os-plan-product`"
---

# source-command-agent-os-plan-product

Use this skill when the user asks to run the migrated source command `agent-os-plan-product`.
