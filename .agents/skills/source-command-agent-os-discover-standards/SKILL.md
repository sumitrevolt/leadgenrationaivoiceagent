---
name: "source-command-agent-os-discover-standards"
description: "Migrated source command `agent-os-discover-standards`"
---

# source-command-agent-os-discover-standards

Use this skill when the user asks to run the migrated source command `agent-os-discover-standards`.
