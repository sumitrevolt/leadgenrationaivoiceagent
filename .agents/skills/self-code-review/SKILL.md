...
- Secrets sirf `.env` (`check_secrets.py` se verify) — code/commit/log/AGENTS.md me kabhi nahi. Webhook = signature-verify FIRST + prod fail-CLOSED 503 (Twilio/Vobiz/HMAC pattern).
