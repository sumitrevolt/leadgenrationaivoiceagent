...
- **Trace proof:** `data/typesafe_decisions.jsonl` me decision record (`tsadm-20260919T043330-f9dbf7`) + uska outcome record — dono append-only, `outcome` decision record me null hi rehta hai.
