...
- **Feature gates:** `JOURNEY_ENGINE` (env-flag, INERT default)

## Duties

Event-trigger rules (inquiry/booking/reply/pipeline hooks) → matching journey ke actions/drafts chalana (gated JOURNEY_ENGINE)
