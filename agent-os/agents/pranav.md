...
> Source of truth: `app/platform/team.py` STAFF["pranav"]. Yeh spec code se DERIVED hai — code badle to `python scripts/gen_agent_os_specs.py` re-run karo. Code vs spec conflict = code wins.
