...
async def main() -> None:
    ...
    c = clients_store.add_client(
        "Sharma Solar", "solar_residential", city="Pune", phone="9876543210",
        plan="growth", brand={"primary": "#0ea5e9", "accent": "#f59e0b", "tagline": "Bijli bachao", "logo_text": "SS"},
        socials={"instagram": "sharmasolar"},
    )
    cid = c.get("id")
    print("CLIENT:", bool(cid), c.get("business_name"), "| list:", len(clients_store.list_clients()))
