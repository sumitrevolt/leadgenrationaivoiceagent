...
class TwilioHandler:
    ...
    async def make_call(
        self, to_number: str, call_id: str, webhook_url: str | None = None
    ) -> str | None:
        """
    ...
    async def get_call_status(self, call_sid: str) -> TwilioCallResult | None:
    ...
    def generate_stream_response(self, stream_url: str, initial_text: str | None = None) -> str:
        """
    ...
    async def play_audio(self, call_sid: str, audio_url: str) -> bool:
    ...
    async def get_recording_url(self, call_sid: str) -> str | None:
        ...
        try:
            recordings = await asyncio.to_thread(self.client.recordings.list, call_sid=call_sid)
...
class TwilioWebhookHandler:
    ...
    async def handle_voice_webhook(
        self, call_sid: str, call_id: str, speech_result: str | None = None
    ) -> str:
        """
    ...
    async def handle_status_webhook(
        self, call_sid: str, call_id: str, status: str, duration: int | None = None
    ) -> dict[str, Any]:
        """
