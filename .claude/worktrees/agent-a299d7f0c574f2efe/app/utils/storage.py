...
async def upload_to_gcs(
    bucket_name: str, file_path: str, content: bytes, content_type: str = "application/octet-stream"
) -> str:
    """
...
async def download_from_gcs(bucket_name: str, file_path: str) -> bytes:
    """
...
async def delete_from_gcs(bucket_name: str, file_path: str) -> bool:
    """
...
async def generate_signed_url(
    bucket_name: str, file_path: str, expiration_minutes: int = 60
) -> str:
    """
...
async def generate_thumbnail(
    image_content: bytes, size: tuple[int, int] = (150, 150), quality: int = 85
) -> bytes:
    """
...
async def list_files_in_bucket(bucket_name: str, prefix: str = "", max_results: int = 100) -> list:
    """
