...
class ConversationManager:
    ...
    # State transitions
    STATE_TRANSITIONS = {
        ConversationState.OPENING: [ConversationState.INTRODUCTION, ConversationState.ENDED],
        ...
        ConversationState.CALLBACK_SCHEDULING: [ConversationState.CLOSING],
    ...
    def get_conversation(self, call_id: str) -> ConversationContext | None:
    ...
    def add_turn(
        ...
        turn = ConversationTurn(role=role, content=content, intent=intent, entities=entities or {})
    ...
    def _update_state(self, context: ConversationContext, intent: str, entities: dict[str, Any]):
    ...
    def _update_qualification(
        self, context: ConversationContext, intent: str, entities: dict[str, Any]
    ):
    ...
    def get_next_question(self, call_id: str) -> str | None:
    ...
    def end_conversation(self, call_id: str) -> ConversationContext | None:
    ...
    def get_conversation_summary(self, call_id: str) -> dict[str, Any]:
        ...
        return {
            ...
            "transcript": [
                {"role": t.role, "content": t.content, "intent": t.intent} for t in context.turns
            ],
        }
