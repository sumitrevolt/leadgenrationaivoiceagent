...
3. **Dunning tone**: blame nahi ("payment nahi gaya" not "aapne nahi diya"), plain-text, direct pay-link, batao kya rukega (posts/calls/reports). D14 win-back = warm, no guilt.
