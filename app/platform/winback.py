    ...
    try:
        ...
        if etype == "customer":
            ...
            wa_msg = (
                ...
                "naye features + ₹999/mahina starter plan hai. 2-minute ka FREE "
                f"Google audit dekh lijiye: {_SITE_URL}/audit?utm_source=winback 😊"
            )
            subject = f"{name} — wapas hello! (free audit + naya ₹999 plan)"
            body = (
                ...
                "review automation) aur starter plan sirf ₹999/mahina.\n\n"
