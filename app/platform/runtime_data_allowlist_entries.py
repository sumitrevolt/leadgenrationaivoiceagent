...
ENTRIES: list[dict[str, Any]] = [
    ...
    {
        "allowlist_id": "ops.outreach.log_files",
        "file": "scripts/check_outreach_pipeline.py",
        "line_or_symbol": "log_path",
        "path_pattern": "data/outreach_log.jsonl",
        "store_id": "ops.outreach.logs",
        "access_modes": ["READ"],
        "reason": "Operational diagnostic script reads outreach logs to report send history.",
        "migration_tier": 3,
        "target_change_set": "runtime-data-cutover-wave-3",
        "owner": "ops",
        "production_relevance": "LIVE",
        "review_condition": "Read-only diagnostic; must never append to outreach logs.",
    },
    {
