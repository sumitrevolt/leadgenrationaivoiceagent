...
ENTRIES: list[dict[str, Any]] = [
    ...
    # under review are new debt, not newly visible debt.
    {
        ...
        "path_pattern": "_entries_path(agent_id)",
    ...
    },
    {
        ...
        "path_pattern": "os.path.join(root, name, 'entries.jsonl')",
        "store_id": "platform.workforce_memory",
    ...
    {
        "allowlist_id": "platform.workforce_memory.root",
        "file": "app/platform/workforce_memory.py",
        "line_or_symbol": "_ROOT_DEFAULT",
        "path_pattern": "os.path.join('data', 'workforce_memory')",
        "store_id": "platform.workforce_memory",
        "access_modes": ["CREATE", "READ"],
        "reason": "Store root constant (data/workforce_memory).",
        "migration_tier": 2,
        "target_change_set": "runtime-data-cutover-wave-2",
        "owner": "platform",
        "production_relevance": "LIVE",
        "review_condition": "WORKFORCE_MEMORY_DIR override is tests/canary only.",
    },
    {
        "allowlist_id": "platform.workforce_memory.root_fn",
        "file": "app/platform/workforce_memory.py",
        "line_or_symbol": "_root",
        "path_pattern": "_ROOT_DEFAULT",
        "store_id": "platform.workforce_memory",
        "access_modes": ["CREATE", "READ"],
    ...
    },
    {
        ...
        "path_pattern": "_persona_path(agent_id)",
        "store_id": "platform.workforce_memory",
    ...
    },
    {
        ...
        "path_pattern": "os.path.join(_root(), '_shared')",
        "store_id": "platform.workforce_memory",
        "access_modes": ["CREATE"],
    ...
    },
    {
        ...
        "path_pattern": "os.path.join(_shared_dir(), 'entries.jsonl')",
        "store_id": "platform.workforce_memory",
        "access_modes": ["APPEND", "READ", "CREATE"],
    ...
    },
    {
        ...
        "path_pattern": "os.path.join(rd, f'{node_id}.md')",
        "store_id": "platform.workforce_memory",
