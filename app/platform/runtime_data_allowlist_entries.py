...
ENTRIES: list[dict[str, Any]] = [
    ...
    # tooling, re-declare it against its tracked path.
    {
        ...
        "access_modes": ["READ", "CREATE", "REWRITE"],
        "reason": "Agent persistent memory store (JSON). Written by agent loop, read on startup.",
        "migration_tier": 3,
        "target_change_set": "runtime-data-cutover-wave-3",
        "owner": "agents",
        "production_relevance": "LIVE",
        "review_condition": "Any change to agent memory schema or path must re-verify agent_events writes.",
    },
    {
        ...
        "access_modes": ["CREATE", "APPEND"],
        "reason": "Telegram inbound message buffer. Appended by webhook handler before tenant routing.",
        "migration_tier": 2,
        "target_change_set": "runtime-data-cutover-wave-2",
        "owner": "telegram",
        "production_relevance": "LIVE",
        "review_condition": "Any change to telegram inbox path must re-verify webhook ingestion.",
    },
    {
        ...
        "access_modes": ["CREATE"],
        "reason": "Outbound renewal-draft log directory for the jiya-makeover renewal script.",
        "migration_tier": 3,
        "target_change_set": "runtime-data-cutover-wave-3",
        "owner": "outreach",
        "production_relevance": "OFFLINE_TOOLING",
        "review_condition": "Path change must be reflected in dunning.jsonl readers.",
    },
    {
        ...
        "store_id": "telegram.inbox",
        "access_modes": ["READ"],
        "reason": "Read-only diagnostic probe for telegram inbox. Never writes.",
        "migration_tier": 3,
        "target_change_set": "runtime-data-cutover-wave-3",
        "owner": "telegram",
        "production_relevance": "OFFLINE_TOOLING",
        "review_condition": "Probe must remain read-only; any write needs re-declaration.",
    },
    {
        ...
        "access_modes": ["LOCK"],
        "reason": "Setup lock file preventing concurrent telegram bootstrap runs.",
        "migration_tier": 3,
        "target_change_set": "runtime-data-cutover-wave-3",
        "owner": "telegram",
        "production_relevance": "OFFLINE_TOOLING",
    ...
    },
    {
        ...
        "access_modes": ["REWRITE", "READ"],
        "reason": "Telegram group creation results file. Written by group creator script.",
        "migration_tier": 3,
        "target_change_set": "runtime-data-cutover-wave-3",
        "owner": "telegram",
        "production_relevance": "OFFLINE_TOOLING",
        "review_condition": "Path change must not break group creation flow.",
    },
    {
    ...
    },
    {
        ...
        "access_modes": ["APPEND"],
        "reason": "WAHA watchdog log file. Appended by watchdog monitoring.",
        "migration_tier": 3,
        "target_change_set": "runtime-data-cutover-wave-3",
        "owner": "waha",
        "production_relevance": "OFFLINE_TOOLING",
    ...
    },
    {
        ...
        "store_id": "waha_watchdog",
        "access_modes": ["REWRITE"],
        "reason": "WAHA watchdog health status file. Rewritten by watchdog.",
        "migration_tier": 3,
        "target_change_set": "runtime-data-cutover-wave-3",
        "owner": "waha",
        "production_relevance": "OFFLINE_TOOLING",
        "review_condition": "Path change must not break watchdog health monitoring.",
    },
]
