...
_OVERRIDES: dict[str, FlagMeta] = {
    ...
    "HQ_AUTO_CHASE": _m(
        ...
        customer=True,
        provider=True,
        companions=("HQ_AUTO_CHASE_APPROVAL_ID",),
        default="0",
        canary="HQ_CHASE_DAILY_CAP=2 first, verify sent+drafts, then raise",
        kill="HQ_AUTO_CHASE=0",
    ),
    "HQ_AUTO_CHASE_APPROVAL_ID": _m(
        "HQ_AUTO_CHASE_APPROVAL_ID",
        FlagValueKind.CREDENTIAL_REFERENCE,
        FlagGovernance.CONFIGURATION_NOT_SWITCH,
        notes="Owner OS approval id; must be approved, unexpired, and bound to the current chase policy hash",
        owner="platform",
        risk="outbound",
        default="",
        parser="opaque_reference",
    ),
