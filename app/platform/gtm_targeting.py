...
CITY_TIERS: dict[str, list[tuple[str, str]]] = {
    ...
    "T2": [
        ...
        ("Nagpur", "MH"), ("Indore", "MP"), ("Bhopal", "MP"), ("Visakhapatnam", "AP"),
        ("Patna", "BR"), ("Vadodara", "GJ"), ("Ludhiana", "PB"), ("Agra", "UP"),
        ("Nashik", "MH"), ("Rajkot", "GJ"), ("Varanasi", "UP"), ("Coimbatore", "TN"),
        ("Kochi", "KL"), ("Chandigarh", "CH"), ("Guwahati", "AS"), ("Mysuru", "KA"),
        ("Thiruvananthapuram", "KL"), ("Jodhpur", "RJ"), ("Ranchi", "JH"), ("Raipur", "CG"),
        ("Madurai", "TN"),
    ],
    "T3": [
        ("Kolhapur", "MH"), ("Aurangabad", "MH"), ("Solapur", "MH"), ("Amravati", "MH"),
        ("Jalandhar", "PB"), ("Amritsar", "PB"), ("Dehradun", "UK"), ("Gwalior", "MP"),
        ("Jabalpur", "MP"), ("Bhubaneswar", "OD"), ("Cuttack", "OD"), ("Tiruchirappalli", "TN"),
        ("Salem", "TN"), ("Hubli", "KA"), ("Mangalore", "KA"), ("Belgaum", "KA"),
        ("Vijayawada", "AP"), ("Guntur", "AP"), ("Warangal", "TS"), ("Nellore", "AP"),
        ("Bareilly", "UP"), ("Aligarh", "UP"), ("Moradabad", "UP"), ("Gorakhpur", "UP"),
        ("Udaipur", "RJ"), ("Ajmer", "RJ"), ("Bikaner", "RJ"), ("Siliguri", "WB"),
        ("Durgapur", "WB"), ("Jamshedpur", "JH"),
    ],
}
