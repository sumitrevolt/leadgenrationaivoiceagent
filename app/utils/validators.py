...
def validate_phone_number(
    phone: str, default_region: str = "IN"
...
def validate_email(email: str) -> tuple[bool, str | None, str | None]:
    """
...
def validate_indian_pincode(pincode: str) -> tuple[bool, str | None, str | None]:
    """
...
def validate_niche(niche: str) -> tuple[bool, str | None, str | None]:
    """
