...
_GENERAL_HASHTAGS: List[str] = [
    "#LocalBusiness", "#SmallBusinessIndia", "#SupportLocal", "#Vocal4Local",
    "#India", "#SpecialOffer", "#BestService", "#Trending",
]

_NICHE_HASHTAGS: Dict[str, List[str]] = {
    "real_estate": [
        "#RealEstate", "#PropertyForSale", "#DreamHome", "#RealEstateIndia",
        "#HomeBuying", "#SiteVisit", "#NewLaunch", "#PropertyInvestment",
    ],
    "real_estate_luxury": [
        "#LuxuryRealEstate", "#LuxuryHomes", "#PremiumProperty", "#HNI",
        "#LuxuryLiving", "#PenthouseLife", "#RealEstateIndia", "#DreamHome",
    ],
    "studying_abroad": [
        "#StudyAbroad", "#OverseasEducation", "#StudentVisa", "#IELTS",
        "#StudyInCanada", "#StudyInUK", "#AbroadDreams", "#EducationConsultant",
    ],
    "home_loans": [
        "#HomeLoan", "#LoanAgainstProperty", "#EMI", "#HousingFinance",
        "#BalanceTransfer", "#HomeLoanIndia", "#DreamHomeLoan", "#FinanceTips",
    ],
    "solar_residential": [
        "#SolarEnergy", "#RooftopSolar", "#SolarPanels", "#GoSolar",
        "#SolarIndia", "#CleanEnergy", "#BijliBachat", "#SolarSubsidy",
    ],
    "solar_commercial": [
        "#CommercialSolar", "#SolarForBusiness", "#SolarEPC", "#GoSolar",
        "#SolarIndia", "#EnergySavings", "#GreenBusiness", "#NetMetering",
    ],
    "insurance": [
        "#Insurance", "#LifeInsurance", "#HealthInsurance", "#TermPlan",
        "#FamilyFirst", "#FinancialPlanning", "#InsuranceIndia", "#SecureFuture",
    ],
    "coaching": [
        "#Coaching", "#CoachingClasses", "#ExamPrep", "#StudyTips",
        "#NEET", "#JEE", "#Toppers", "#EducationIndia",
    ],
    "interior_designers": [
        "#InteriorDesign", "#HomeDecor", "#InteriorDesigner", "#HomeInteriors",
        "#ModularKitchen", "#HomeMakeover", "#DecorGoals", "#DesignIndia",
    ],
    "dental_implants": [
        "#DentalCare", "#DentalImplants", "#SmileMakeover", "#Dentist",
        "#OralHealth", "#TeethWhitening", "#HealthySmile", "#DentalClinic",
    ],
    "general": list(_GENERAL_HASHTAGS),
}


def _hashtags_for(niche: str, seed_tags: Optional[List[str]] = None) -> List[str]:
...
_FESTIVAL_TEMPLATES: List[Dict[str, str]] = [
    {
        "caption": ("🪔 {business_name} ki taraf se {occasion} ki hardik shubhkamnayein! ✨\n"
    ...
    {
        "caption": ("🎉 {occasion} mubarak ho! {business_name} laya hai khushiyon ka tohfa.\n"
...
async def generate_post(
    ...
    if not image_idea.strip():
        image_idea = (f"{business_name} ki festive-theme creative photo" if occasion
...
_CAL_FALLBACK: List[Tuple[str, str, str]] = [
    ("Monday", "Tip / Gyaan",
     "💡 Pro tip from {business_name}: {tip_line}"),
    ("Tuesday", "Offer / Deal",
