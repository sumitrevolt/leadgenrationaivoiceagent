...
PACKAGES: list[dict] = [
    {
        ...
        "features": [
            ...
            "AI video ads (Reels/Shorts) — har ~5 din naya video, SAB niches ke liye, aapki OK pe publish (koi extra charge nahi)",
            "Auto social publishing — approved content khud post ho Telegram/Insta/FB/LinkedIn pe (schedule + auto, 1-click share se aage)",
