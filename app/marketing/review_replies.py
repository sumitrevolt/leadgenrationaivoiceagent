...
_POSITIVE = [
    ("short", "Dhanyawad! 🙏 Aapka pyaar hi {business_name} ki asli kamai hai. Phir se zaroor aaiye!"),
    ("medium", "Bahut bahut shukriya aapke kind words ke liye! 🙏 {business_name} ki team ke liye "
               "aapki ye review kisi award se kam nahi. Agli baar bhi isi quality ki guarantee — "
               "zaroor padhariye!"),
    ("detailed", "Dil se dhanyawad! 🙏 Aap jaise customers ki wajah se hi {business_name} aaj is "
...
_NEGATIVE = [
    ("short", "Maafi chahte hain aapke experience ke liye. 🙏 {business_name} isse seriously le raha "
              "hai — please humein direct call/DM karein, turant solve karenge."),
    ("medium", "Aapke experience ke liye dil se maafi. Ye humare standard se bilkul neeche hai aur "
    ...
    ("detailed", "Sabse pehle — sincere apology. 🙏 Jo hua wo {business_name} ke values ke khilaaf "
...
_NEUTRAL = [
    ("short", "Feedback ke liye shukriya! 🙏 {business_name} hamesha behtar hone ki koshish me hai."),
    ("medium", "Aapke honest feedback ke liye dhanyawad! {business_name} aapke points ko seriously "
               "le raha hai — agli visit par aapko farak zaroor dikhega. Koi bhi baat ho to humein "
               "direct bata sakte hain. 🙏"),
    ("detailed", "Thank you for taking the time to review us! 🙏 {business_name} me hum har feedback "
...
_NEG_WORDS = ("kharab", "bekar", "worst", "bad ", "ganda", "fraud", "cheat", "rude",
              "slow", "late", "refund", "complaint", "dhokha", "waste", "poor")
_POS_WORDS = ("accha", "achha", "best", "great", "amazing", "excellent", "awesome",
              "badhiya", "mast", "love", "perfect", "wonderful", "shandar")


def _sentiment(review_text: str, rating: Optional[float]) -> str:
...
def _template_replies(business_name: str, sentiment: str) -> List[Dict[str, str]]:
    ...
    return [{"label": label, "text": text.format(business_name=business_name)}
