...
TEMPLATE_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    # ------------------------------------------------------------------ P1-2
    # Three tenant-niche compositions (T05). They exist so the novelty gate has
    # genuinely DIFFERENT compositions to rotate a tenant across — the driving
    # complaint is "same video roz". A registry entry is only reachable when
    # `<renderer_root>/<dir>/index.html` is a real file on disk (`template_dir`),
    # so each of these ships with its own authored composition.
    "makeover_before_after_v1": {
        "template_id": "makeover_before_after_v1",
        "template_version": "1.0.0",
        "dir": "templates/makeover_before_after_v1",
        "label": "Makeover before/after transformation reel (photo-led)",
        "scene_count": 6,
        "duration_s": 25.4,
        "aspect_ratios": ("9:16",),
        # Photo-led: the before/after arc is carried by consented imagery. The
        # `before_after` RECIPE still requires verified source assets
        # (`recipe_allowed`), so this flag never bypasses that gate.
    ...
    "salon_service_v1": {
        "template_id": "salon_service_v1",
        "template_version": "1.0.0",
        "dir": "templates/salon_service_v1",
        "label": "Salon treatment / service-menu showcase reel",
        "scene_count": 6,
        "duration_s": 25.4,
        "aspect_ratios": ("9:16",),
        "requires_photos": False,
    ...
    "bridal_package_v1": {
        "template_id": "bridal_package_v1",
        "template_version": "1.0.0",
        "dir": "templates/bridal_package_v1",
        "label": "Bridal / wedding-season package spotlight reel",
        "scene_count": 6,
        "duration_s": 25.4,
        "aspect_ratios": ("9:16",),
        "requires_photos": False,
