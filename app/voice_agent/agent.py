...
from app.exceptions import TelephonyException
...
class VoiceAgent:
    ...
    async def process_speech(
        ...
        try:
            ...
            # 3. Detect intent
            intent = await self.intent_detector.detect(text=user_text, context=context)
    ...
    async def text_to_audio(self, text: str, voice_id: str | None = None) -> bytes:
    ...
    async def get_call_status(self, call_id: str) -> CallContext | None:
