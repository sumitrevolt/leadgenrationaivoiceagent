...
_WORD_MAP: dict[str, str] = {
    # question words
    "क्या": "kya", "कैसे": "kaise", "कैसा": "kaisa", "कब": "kab",
    "कहाँ": "kahan", "कहां": "kahan", "क्यों": "kyun", "क्यूँ": "kyun",
    "कितना": "kitna", "कितने": "kitne", "कितनी": "kitni", "कौन": "kaun",
    "मतलब": "matlab", "समझाओ": "samjhao", "समझा": "samjha", "समझो": "samjho",
    "बताओ": "batao", "बता": "bata", "बताते": "batate", "बताइए": "bataiye",
    # price / plan
    "चार्ज": "charge", "कीमत": "kimat", "दाम": "daam", "पैसा": "paisa",
    "पैसे": "paise", "रुपये": "rupaye", "रुपया": "rupaya", "प्लान": "plan",
    "पैकेज": "package", "महीना": "mahina", "महीने": "mahine", "साल": "saal",
    ...
    "इंटरेस्टेड": "interested", "इंटरेस्ट": "interest",
    # no / objection
    "नहीं": "nahi", "नही": "nahi", "ना": "na", "मत": "mat", "बंद": "band",
    "करो": "karo", "महंगा": "mehenga", "मेहंगा": "mehenga", "एजेंसी": "agency",
    "सोच": "soch", "भरोसा": "bharosa", "बाद": "baad",
    # busy / timing
    ...
    "है": "hai", "और": "aur", "में": "me", "को": "ko", "से": "se", "पे": "pe",
    "पर": "par", "का": "ka", "की": "ki", "के": "ke", "वो": "wo", "ये": "ye",
    "यह": "yeh", "मुझे": "mujhe", "मैं": "main", "तुम": "tum", "आप": "aap",
    "मिलता": "milta", "होता": "hota", "गूगल": "google", "पोस्ट": "post",
}
