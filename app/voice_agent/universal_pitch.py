...
UNIVERSAL_AGENT_INTRO = (
    ...
    "2026 ka AI social marketing: Instagram, Facebook, WhatsApp pe roz posts aur ads, "
    "agency jaisa kharcha nahi. Business grow karna mera kaam — "
    "FREE trial dekho, main best solution dhoondungi."
)

PITCH_SHORT = (
    "Social posts, ads aur Google boost — sab AI se automatic, "
    "₹1,199 mahine se, agency se sasta."
)
