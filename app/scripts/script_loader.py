...
class ScriptLoader:
    ...
    @classmethod
    def load_script(cls, niche: str, language: str = "hinglish") -> CallScript | None:
    ...
    @classmethod
    def _get_predefined_script(cls, niche: str, language: str) -> CallScript | None:
    ...
    def _get_default_script(cls, language: str = "hinglish") -> CallScript:
        ...
        return CallScript(
            ...
            key_benefits=["Apni efficiency improve karein", "Cost kam karein", "Revenue badhayein"],
            social_proof="Humne 500+ businesses ko successfully help kiya hai.",
            qualification_questions=[
                {
                    "question": "Kya aap business ke owner hain ya decision maker?",
                    "intent": "decision_maker",
                },
                {
                    "question": "Currently aap kya solution use kar rahe hain?",
                    "intent": "current_solution",
                },
                {
                    "question": "Kya isko improve karne mein interest hai?",
    ...
    def _real_estate_script(cls) -> CallScript:
        ...
        return CallScript(
            ...
            qualification_questions=[
                {
                    "question": "Kya aap property investment mein interested hain - residential ya commercial?",
                    "intent": "interest_type",
                },
                ...
                {
                    "question": "Timeline kya hai aapka? Immediate investment ya future planning?",
                    "intent": "timeline",
                },
    ...
    def _real_estate_script_hindi(cls) -> CallScript:
        ...
        return CallScript(
            ...
            qualification_questions=[
                {
                    "question": "क्या आप प्रॉपर्टी इन्वेस्टमेंट में रुचि रखते हैं?",
                    "intent": "interest_type",
                },
    ...
    def _real_estate_script_english(cls) -> CallScript:
        ...
        return CallScript(
            ...
            qualification_questions=[
                {
                    "question": "Are you interested in residential or commercial property investment?",
                    "intent": "interest_type",
                },
    ...
    def _solar_script(cls) -> CallScript:
        ...
        return CallScript(
            ...
            qualification_questions=[
                ...
                {
                    "question": "Aapke paas khud ki property hai ya rent pe hain?",
                    "intent": "ownership",
                },
                {
                    "question": "Terrace ya rooftop available hai solar panels ke liye?",
                    "intent": "space_available",
                },
                {
                    "question": "Kya aapne government subsidy ke baare mein suna hai?",
                    "intent": "subsidy_awareness",
                },
            ],
            objection_responses={
    ...
    def _logistics_script(cls) -> CallScript:
        ...
        return CallScript(
            ...
            qualification_questions=[
                ...
                {
                    "question": "Current logistics partner se satisfied hain?",
                    "intent": "satisfaction",
                },
            ],
            objection_responses={
    ...
    def _digital_marketing_script(cls) -> CallScript:
        ...
        return CallScript(
            ...
            qualification_questions=[
                {
                    "question": "Currently digital marketing karwa rahe hain ya in-house kar rahe hain?",
                    "intent": "current_status",
                },
                {
                    "question": "Website hai aapki? Monthly traffic kitna hai approximately?",
                    "intent": "website_status",
                },
                {
                    "question": "Main business channel kaunsa hai - B2B ya B2C?",
                    "intent": "business_type",
                },
                {
                    "question": "Monthly marketing budget approximately kitna hai?",
                    "intent": "budget",
                },
            ],
            objection_responses={
    ...
    def _manufacturing_script(cls) -> CallScript:
        ...
        return CallScript(
            ...
            qualification_questions=[
                {
                    "question": "Currently {product_category} kahan se le rahe hain?",
                    "intent": "current_supplier",
                },
                {"question": "Monthly requirement approximately kitni hai?", "intent": "volume"},
                {
                    "question": "Kya specific quality standards follow karte hain? ISO, etc?",
    ...
    def _insurance_script(cls) -> CallScript:
        ...
        return CallScript(
            ...
            qualification_questions=[
                {
                    "question": "Currently koi life insurance hai aapke paas?",
                    "intent": "existing_policy",
                },
                {
                    "question": "Family mein kaun kaun hain - spouse, children?",
                    "intent": "family_status",
                },
                {
                    "question": "Monthly kitna invest kar sakte hain insurance mein?",
                    "intent": "budget",
                },
                {
                    "question": "Main priority kya hai - savings, protection, ya dono?",
                    "intent": "priority",
                },
            ],
            objection_responses={
    ...
    @classmethod
    def get_response_for_objection(cls, script: CallScript, objection_type: str) -> str:
    ...
    def get_qualification_question(
        cls, script: CallScript, answered_intents: list[str]
    ) -> dict[str, str] | None:
    ...
    @classmethod
    def format_script_with_variables(cls, text: str, variables: dict[str, str]) -> str:
