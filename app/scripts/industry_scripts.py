...
- Maya, LeadGen AI""",
    ...
    "solar_b2b": IndustryScript(
        ...
        qualification_questions=[
            ...
            {"question": "Ek installation ka average ticket size kya hai?", "intent": "deal_value"},
        ],
        objection_responses={
...
- LeadGen AI Team""",
    ...
    "coaching_b2b": IndustryScript(
        ...
        qualification_questions=[
            ...
            {"question": "Counseling team mein kitne log hain?", "intent": "team_size"},
        ],
        objection_responses={
...
- LeadGen AI""",
    ...
    "healthcare_b2b": IndustryScript(
        ...
        qualification_questions=[
            ...
            {"question": "High-value treatments mein kya offer karte hain?", "intent": "services"},
        ],
        objection_responses={
...
- LeadGen AI""",
    ...
    "insurance_b2b": IndustryScript(
        ...
        qualification_questions=[
            ...
            {"question": "Team mein kitne agents hain?", "intent": "team_size"},
            {"question": "Monthly kitne new leads aate hain?", "intent": "lead_volume"},
            {
...
- {client_name}""",
    ...
    "coaching_b2c": IndustryScript(
        ...
        qualification_questions=[
            {"question": "Student class 11th mein hai ya 12th mein?", "intent": "current_class"},
            {"question": "School kaun sa hai? CBSE ya State board?", "intent": "school_info"},
            {"question": "Abhi koi coaching chal rahi hai ya nahi?", "intent": "current_coaching"},
            {
...
class IndustryScriptManager:
    ...
    def get_b2b_script(self, industry_code: str) -> IndustryScript | None:
        """Get B2B script for selling your service"""
        return self.b2b_scripts.get(industry_code)

    def get_b2c_script(self, industry_code: str) -> IndustryScript | None:
    ...
    def get_qualification_questions(
        self, industry_code: str, script_type: ScriptType = ScriptType.B2B_PLATFORM_SALES
    ) -> list[dict[str, str]]:
