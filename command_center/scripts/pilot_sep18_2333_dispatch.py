...
msgs = [
    {
        "ts": "2026-09-18T23:33:00+05:30",
        "from": "PILOT",
        "to": "ALL",
        "task_id": "REV-COMMAND-0918-2333",
        "type": "REVENUE_COMMAND",
        "priority": "P0",
...
for t in tasks:
    ...
    if tid == "ENG-009" or tid == "ENG-011":
        ...
        if tid == "ENG-009":
            ...
            t["evidence"] = (
                "23:33 IST: DSH worker Up 7h healthy (live VPS probe 94dca989). ENG-009 closed."
            )
            t["pilot_note"] = "ENG-009 AUTO-CLOSED — DSH running, shadow mode."
        elif tid == "ENG-011":
            t["evidence"] = (
                "23:33 IST: Tata 401 confirmed live in call_loop.log (13:24:11Z). Loop TRAI band sleeping safe. Circuit breaker still pending — P1 downgrade."
            )
            t["updated_at"] = "2026-09-18T23:33:00+05:30"
    elif tid == "PLT-017":
        t["status"] = "🔴 BLOCKED"
        t["updated_at"] = "2026-09-18T23:33:00+05:30"
        t["evidence"] = (
            "23:33 IST LIVE: Tata 401 'Unable to process' confirmed in call_loop.log 13:24:11Z. Shared-CLI dead. Owner portal key rotation required. Deadline 23:30."
        )
        ...
        t["updated_at"] = "2026-09-18T23:33:00+05:30"
        t["evidence"] = (
            "23:33 IST: Loop TRAI band sleeping — batch 49 done, 147 OK total. Auto-restart 09:00 IST."
        )
...
pin["vps_status"] = (
    "VPS UP /health 200 v680722c8 uptime 2h8m. DSH Up 7h. Loop TRAI-band sleeping (147 calls OK batch 49). Tata 401 dead. WAHA QR mode. Rev Rs1,999, GAP Rs4,98,001."
)
pin["bottleneck"] = (
    "#1 Tata 401 -> 0 connects (owner portal fix) | #2 WAHA QR re-auth (owner) | #3 Jiya sole payer RED"
)
pin["pipeline"] = "Gaurav Rs6,425 proposal pending | Jiya Rs1,499 overdue | leads=5 available"
pin["action"] = (
    "PLT-017 blocked on owner Tata key rotation | SUX-013 Jiya follow-up | SL-004 Gaurav WA convert | 09:00 call loop auto-start"
)
