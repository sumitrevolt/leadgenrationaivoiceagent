...
FRESH live evidence 08:20 IST (this run, in-window SSH):
  ...
  - hot-queue 09-04 ABSENT (2nd day date-lock
  last 09-03 03:30).
...
pin["vps_status"] = ("VPS UP /health 37a1daf8 healthy uptime12h19m
...
pin["action"] = ("08:26 IST gate rebump: ENG-004 ship sendText+msgid+reachability
