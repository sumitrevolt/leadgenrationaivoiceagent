...
def main() -> int:
    ...
    flags = {k: os.environ.get(k, "") for k in ("AUTO_INVOICE", "EMAIL_WARMUP", "USAGE_ALERTS", "WARMUP_START_DATE")}
    ...
    try:
        from app.billing.subscription import BillingCycle, PRICING_PLANS, billing_manager
