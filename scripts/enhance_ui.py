...
new_nav = """    <nav class="nav" role="menubar" aria-label="Main menu">
      ...
      <a class="admin-auth-only" href="/app/inbox" id="navHotQueue" role="menuitem" aria-label="Hot Queue 15-minute outreach sprint" style="background:#4f46e5
      color:#fff
      font-weight:700
      ...
      color:#fff
      font-weight:700
      "><span class="ic" aria-hidden="true">➕</span> Add & Onboard Customer</a>
      ...
      <a href="/app/automation" role="menuitem" aria-label="Mission Control automation"><span class="ic" aria-hidden="true">🎛</span> Automation Control Plane <span class="badge" id="nav-auto-appr" style="background:#f59e0b
      ...
      display:none">OFF</span></a>

      <div class="sec nav-group" role="presentation">7. System</div>
      <a href="/app/control-center" id="navControlCenter" role="menuitem" aria-label="Control Center system observability"><span class="ic" aria-hidden="true">🖥</span> Control Center <span id="navCcGate" class="badge" style="display:none
      background:#64748b">flag OFF</span></a>
      ...
      <a href="#sec-godmode" onclick="expandAdvTech()" role="menuitem" aria-label="God Mode production control" style="background:rgba(239,68,68,.18)
      color:#fca5a5
      font-weight:700"><span class="ic" aria-hidden="true">⚡</span> Advanced / God Mode</a>
