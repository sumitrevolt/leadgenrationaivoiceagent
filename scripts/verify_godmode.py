...
# 1. Health check
r1 = subprocess.run(
    [ssh, "-i", key, "-o", "StrictHostKeyChecking=no", "root@72.61.245.204",
...
print(f"/api/admin/system/summary HTTP: {code} ({'OK - auth required (live)' if code in ('401','403') else 'UNEXPECTED: '+code})")
