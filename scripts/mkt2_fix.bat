...
call "%GIT%" add scripts/mkt2_smoke.py scripts/mkt2_fix.bat scripts/mkt2_deploy.bat scripts/launch_mkt2.bat > mkt2b.log 2>&1
call "%GIT%" commit -m "chore: mkt2 smoke script (quoting-safe VPS verify)" >> mkt2b.log 2>&1
