...
def verify_payment_attribution(
    ref_id, client_id=None, invoice_id=None, amount=None, received_at=None
):
    """
...
def main():
    ...
    parser.add_argument(
        "--received-at", required=True, help="Payment received timestamp (ISO format)"
    )
    ...
    if args.ref_id:
        attribution = verify_payment_attribution(
            args.ref_id, client_id=args.client_id, amount=args.amount, received_at=args.received_at
        )
