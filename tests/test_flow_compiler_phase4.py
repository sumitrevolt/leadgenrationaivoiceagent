...
def test_inputs_map_forces_dag_even_on_linear_chain():
    proc, errs, kind = compile_flow(_flow(
        [{"id": "a", "action": "scrape"},
         {"id": "b", "action": "crm_queue", "inputs_map": {"leads": {"from": "a", "key": "detail"}}}],
        [{"f": "a", "t": "b"}]))
...
def test_non_ancestor_source_rejected():
    ...
    proc, errs, kind = compile_flow(_flow(
        [{"id": "a", "action": "scrape"},
         {"id": "b", "action": "crm_queue", "inputs_map": {"leads": {"from": "c", "key": "detail"}}},
         {"id": "c", "action": "harvest"}],
        [{"f": "a", "t": "b"}, {"f": "a", "t": "c"}]))
...
def test_unknown_key_rejected():
    proc, errs, kind = compile_flow(_flow(
        [{"id": "a", "action": "scrape"},
         {"id": "b", "action": "crm_queue", "inputs_map": {"leads": {"from": "a", "key": "bogus"}}}],
        [{"f": "a", "t": "b"}]))
...
def test_missing_from_node_rejected():
    proc, errs, kind = compile_flow(_flow(
        [{"id": "a", "action": "scrape"},
         {"id": "b", "action": "crm_queue", "inputs_map": {"leads": {"from": "ghost", "key": "detail"}}}],
        [{"f": "a", "t": "b"}]))
