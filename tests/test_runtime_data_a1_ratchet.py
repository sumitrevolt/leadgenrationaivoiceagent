...
# CLASSIFIED, not tolerated — baseline fingerprint count unchanged.
# 2026-08-19: 70 -> 73. Operational scripts (check_outreach_pipeline,
# clean_stale_upi) classified as ops.outreach.warmup_state / ops.upi_cleanup.* (+3).
EXPECTED_ALLOWLIST_ENTRIES = 73
