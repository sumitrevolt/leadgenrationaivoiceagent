...
def test_run_daily_content_orders_paying_before_self(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(auto_content, "_QUEUE_DIR", str(tmp_path / "cq"))
    ...
    clients = [
        {"id": auto_content._SELF_CLIENT_ID, "business_name": "LeadGen AI",
         "niche": "ai_marketing", "plan": "growth", "status": "active"},
        {"id": "d79d690f61b3", "business_name": "Jiya Makeover",
         "niche": "beauty_makeover", "plan": "starter", "status": "active"},
    ]
    ...
    assert processed_order[0] == "d79d690f61b3"
...
def test_client_with_phone_gets_wa_alert(tmp_path, monkeypatch):
    ...
    client = {"id": "d79d690f61b3", "business_name": "Jiya Makeover", "phone": "8712928847"}
    ...
    rec = {"name": "Ravi", "phone": "9876543210", "client_id": "d79d690f61b3", "lead_id": "L1"}
