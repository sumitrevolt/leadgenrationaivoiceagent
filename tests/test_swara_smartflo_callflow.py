...
def test_pick_trunk_returns_non_empty_caller_id_for_vobiz(
    ...
    # Vobiz REMOVED 2026-09-15 — vobiz creds are no longer a trunk source.
    _set(
        monkeypatch,
...
def test_pick_trunk_resolves_did_for_each_armed_trunk(
    ...
    if expected_caller_id:
        ...
        # jio_mobile was removed 2026-09-15 — no trunk should be selected.
        assert provider == "none"
        assert caller_id == ""
