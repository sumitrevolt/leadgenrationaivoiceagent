...
# actions/checkout v4.2.2 (public action commit — not a credential)
CHECKOUT_SHA = "11bd71901bbe5b1630ceea73d27597364c9af683"  # pragma: allowlist secret
...
def test_gate_a_checkout_pinned_and_non_required_name():
    doc = _load(GATE_A)
