...
def test_summarize_clean():
    ...
    # 60 since 2026-09-21: +hot_queue_followup (daily 10:00 IST, ntfy reminder for
    # owner-pack cards stale 24h+). dd1a0c38 added it to STAFF_JOBS + JOB_META + beat
    # but NOT to EXPECTED_GAP_MIN or JOB_INFO, so it had no dead-man gap and no UI
    # entry — three of these tests have been red since. All five registries now agree.
